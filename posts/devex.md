...
A recent study found developers using AI were 19% slower despite _feeling_ 20% faster.[^1]
...
[^1]: METR's ["Measuring the Impact of Early-2025 AI on Experienced Open-Source Developer Productivity"](https://metr.org/blog/2025-07-10-early-2025-ai-experienced-os-dev-study/) a randomized controlled trial with 16 experienced developers completing 246 real tasks. Worth noting: the study authors themselves caution that AI tools are evolving rapidly and results may differ even months later.

[^2]: These are real quotes from recent Hacker News threads. I'm not attributing them because the point isn't to call anyone out, rather to show the range of takes that exist. Both extremes are well-represented with even a cursory search.

[^3]: Grant, Adam. ["Think Again: The Power of Knowing What You Don't Know"](https://adamgrant.net/book/think-again/) (2021). A good read on intellectual humility and updating your beliefs.
