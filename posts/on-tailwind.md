...
If you _haven't_ been paying close attention, though, it's easy to see this list and immediately jump to the base conclusion _"Wow, web development is so unstable."_
...
You might be sitting there thinking, "Ah-ha! I knew it! All my homies _hate_ single file components" or something to that effect.
...
And in this we find our conundrum. If I want to send the result of an RPC over the wire _and_ that result is mostly long strings of CSS utilities, that ends up being a lot of bloat in what should ideally be a thin payload.
...
[^1]: Except for [CSS-in-JS that's evaluated at runtime](https://dev.to/srmagura/why-were-breaking-up-wiht-css-in-js-4g9b). Please understand the drawbacks and consider alternatives.

Discuss on [Hacker News](https://news.ycombinator.com/item?id=46062805) or [Bluesky](https://bsky.app/profile/wlls.dev/post/3m6ku23nlgs2o).
